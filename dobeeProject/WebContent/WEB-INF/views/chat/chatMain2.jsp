		   		...
		   		<div class="modal-dialog cascading-modal" role="document">
					...
					<!--Header-->
						...
						<div class="modal-body mb-0" style="margin-top: 30px;">
						      ...
						      <form id="makeChatRoom" name="makeChatRoom" class="form-horizontal form-bordered" method="post">
...
<script>
	...
	$("#userSelect").change(function(){
		var element = $("#userSelect");
		var data = element.select2('data')[0].text;
		console.log('데이터??'+data);
		/* var userInfo = $("select[name='userSelect'] option:selected").val().split(":");
		var userName = userInfo[0];
		var userMail = userInfo[1];
		console.log('어케 가져와?'+userInfo);

	
		$("#chatUserList").append("<div class='list'><i class='fa fa-user'><span name='name' id='name"+(count++)+"'>"
	...
	$("#makeChatRoomBtn").on('click', function(e){
		...
		var data = $("#userSelect").select2('data').text;
		console.log('이히헝리멍ㄹ'+data);
...
/* 		if($("#newChatRoomName").val() == "" || $("#newChatRoomName").val() == null){
			swal({
				...
				console.log('유저 이메일 가져오니?'+chatUserList);
				var chatRoom = {
