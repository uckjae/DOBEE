...
<div class="side-navbar-wrapper">
		...
		<div class="main-menu">
			<ul id="side-main-menu" class="side-menu list-unstyled">
				<li><a href="#"> <i class="fas fa-home fa-2x" style="color:#888888; font-family: 'Noto Serif KR', serif;">&nbsp;메인</i>
				</a></li>
				<li><a href="noticeList.do"> <i class="fas fa-clipboard-list fa-2x" style="color:#888888; font-family: 'Noto Serif KR', serif;">&nbsp;공지사항</i>
				</a></li>				
				<li><a href="#exampledropdownDropdown" aria-expanded="false"
					data-toggle="collapse"> <i class="fas fa-briefcase fa-2x" style="color:#888888; font-family: 'Noto Serif KR', serif;">&nbsp;근무</i></a>
