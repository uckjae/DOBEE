...
-- 신청
ALTER TABLE `APPLY`
	DROP FOREIGN KEY `FK_MEMBER_TO_DRAFTER`; -- 사원 -> 신청

-- 신청
ALTER TABLE `APPLY`
	DROP FOREIGN KEY `FK_MEMBER_TO_APPROVAL`; -- 사원 -> 신청2
...
-- 신청목록
DROP TABLE IF EXISTS `APPLYCODE` RESTRICT;
...
INSERT INTO ATTENDCODE (ATTCODE, ATTDIV) VALUES(1, '출근');
INSERT INTO ATTENDCODE (ATTCODE, ATTDIV) VALUES(2, '퇴근');
INSERT INTO ATTENDCODE (ATTCODE, ATTDIV) VALUES(3, '부재시작');
INSERT INTO ATTENDCODE (ATTCODE, ATTDIV) VALUES(4, '부재끝');
...
INSERT INTO CHATTYPE (CHATCODE, CHATTYPE) VALUES(1, 'SELF');
INSERT INTO CHATTYPE (CHATCODE, CHATTYPE) VALUES(2, 'DM');
INSERT INTO CHATTYPE (CHATCODE, CHATTYPE) VALUES(3, 'GROUP');
