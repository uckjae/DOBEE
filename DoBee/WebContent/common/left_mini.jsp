...
<div class="col-md-3">
<nav class="side-navbar col-md-1">
	<div class="side-navbar-wrapper ">
		...
		<div class="main-menu">
			...
			<ul id="side-main-menu" class="side-menu list-unstyled">
				...
				<li><a href="forms.html"> <i class="icon-form"></i>
				</a></li>
				<li><a href="charts.html"> <i class="fa fa-bar-chart"></i>
				</a></li>
				<li><a href="tables.html"> <i class="icon-grid"></i>
				</a></li>
				<li><a href="#exampledropdownDropdown" aria-expanded="false"
					data-toggle="collapse"> <i class="icon-interface-windows"></i>
				</a>
				...
				<li><a href="chat.jsp"> <i class="fas fa-comments"></i></a></li>
			</ul>
		</div>
